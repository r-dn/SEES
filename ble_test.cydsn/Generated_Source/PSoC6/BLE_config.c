...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x0Cu, 0x09u, 0x61u, 0x75u,
        0x64u, 0x69u, 0x6Fu, 0x5Fu, 0x63u, 0x79u, 0x62u,
        0x6Cu, 0x65u, 0x03u, 0x03u, 0x84u, 0xCFu, 0x00u,
...
cy_stc_ble_gapp_scan_rsp_data_t cy_ble_scanRspData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x0Cu, 0x09u, 0x61u, 0x75u, 0x64u, 0x69u, 0x6Fu,
        0x5Fu, 0x63u, 0x79u, 0x62u, 0x6Cu, 0x65u, 0x02u,
        0x0Au, 0x00u, 0x03u, 0x19u, 0x80u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
...
static uint8_t cy_ble_attValues[0x015Bu] = {
    /* Device Name */
    (uint8_t)'a', (uint8_t)'u', (uint8_t)'d', (uint8_t)'i', (uint8_t)'o', (uint8_t)'_', (uint8_t)'c', (uint8_t)'y',
(uint8_t)'b', (uint8_t)'l', (uint8_t)'e', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Au] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[13] }, /* Central Address Resolution */
    ...
    { 0x00A0u, (void *)&cy_ble_attValues[27] }, /* audio char */
    { 0x00A0u, (void *)&cy_ble_attValues[187] }, /* Custom Descriptor */
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x14u] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0014u, {{0xCF84u, NULL}}                           },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf   */, 0x0014u, {{0xA7BCu, NULL}}                           },
    { 0x0012u, 0xA7BCu /* audio char                          */, 0x01100000u /* ntf   */, 0x0014u, {{0x00A0u, (void *)&cy_ble_attValuesLen[7]}} },
    { 0x0013u, 0xB955u /* Custom Descriptor                   */, 0x01000001u /*       */, 0x0013u, {{0x00A0u, (void *)&cy_ble_attValuesLen[8]}} },
