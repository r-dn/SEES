 ...
 */
#define CY_BLE_CONFIG_GATT_MTU                      (0x00C8u)

/** The GATT Maximum attribute length. */
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x00A0u)
...
#define CY_BLE_CONFIG_L2CAP_ENABLE                  (1u)
    ...
    /** L2CAP MTU Size. */
    #define CY_BLE_CONFIG_L2CAP_MTU                     (200u)
...
/** Max Tx payload size. */
#define CY_BLE_CONFIG_LL_MAX_TX_PAYLOAD_SIZE        (0xC8u)

/** Max Rx payload size. */
#define CY_BLE_CONFIG_LL_MAX_RX_PAYLOAD_SIZE        (0xC8u)
 ...
 */
#define CY_BLE_AUDIO_SERVICE_SERVICE_INDEX   (0x00u) /* Index of audio service service in the cy_ble_customs array */
#define CY_BLE_AUDIO_SERVICE_AUDIO_CHAR_CHAR_INDEX   (0x00u) /* Index of audio char characteristic */
#define CY_BLE_AUDIO_SERVICE_AUDIO_CHAR_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_AUDIO_SERVICE_AUDIO_CHAR_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_AUDIO_SERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of audio service service */
#define CY_BLE_AUDIO_SERVICE_AUDIO_CHAR_DECL_HANDLE   (0x0011u) /* Handle of audio char characteristic declaration */
#define CY_BLE_AUDIO_SERVICE_AUDIO_CHAR_CHAR_HANDLE   (0x0012u) /* Handle of audio char characteristic */
#define CY_BLE_AUDIO_SERVICE_AUDIO_CHAR_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0013u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_AUDIO_SERVICE_AUDIO_CHAR_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Client Characteristic Configuration descriptor */
