...
# Date: Sat, 25 May 2024 23:27:25 GMT
#set_units -time ns
...
create_generated_clock -name {CLK0} -source [get_pins {ClockBlock/periclk}] -edges {1 51 101} [list [get_pins {ClockBlock/ff_div_11}]]
